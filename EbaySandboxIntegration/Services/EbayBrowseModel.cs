...
namespace EbayIntegration
{
    ...
    {
        private string _baseUrl = "https://api.sandbox.ebay.com/buy/browse/v1";
        ...
        /// <param name="auto_correct">A query parameter that enables auto correction. Valid Values: KEYWORD</param>
        ...
        public System.Threading.Tasks.Task<SearchPagedCollection> SearchAsync(string aspect_filter, string auto_correct, string category_ids, string charity_ids, string compatibility_filter, string epid, string fieldgroups, string filter, string gtin, string limit, string offset, string q, string sort)
        {
            return SearchAsync(aspect_filter, auto_correct, category_ids, charity_ids, compatibility_filter, epid, fieldgroups, filter, gtin, limit, offset, q, sort, System.Threading.CancellationToken.None);
        }
        ...
        /// <returns>OK</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<SearchPagedCollection> SearchAsync(string aspect_filter, string auto_correct, string category_ids, string charity_ids, string compatibility_filter, string epid, string fieldgroups, string filter, string gtin, string limit, string offset, string q, string sort, System.Threading.CancellationToken cancellationToken)
        {
            ...
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("auto_correct") + "=").Append(System.Uri.EscapeDataString(ConvertToString(auto_correct, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
            }
    ...
    {
        /// <summary>The first line of the street address. Note: This is conditionally returned in the itemLocation field.</summary>
        ...
        /// <summary>The postal code (or zip code in US) code of the address. Sellers set a postal code (or zip code in US) for items when they are listed. The postal code is used for calculating proximity searches. It is anonymized when returned in itemLocation.postalCode via the API.</summary>
        [Newtonsoft.Json.JsonProperty("postalCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string PostalCode { get; set; }
    
        /// <summary>The state or province of the address. Note: This is conditionally returned in the itemLocation field.</summary>
    ...
    {
        /// <summary>The value of the discounted amount.</summary>
        [Newtonsoft.Json.JsonProperty("value", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Value { get; set; }
    
        /// <summary>The list of valid currencies. Each ISO 4217 currency code includes the currency name followed by the numeric value. For example, the Canadian Dollar code (CAD) would take the following form: Canadian Dollar, 124. For implementation help, refer to &lt;a href='https://developer.ebay.com/devzone/rest/api-ref/browse/types/CurrencyCodeEnum.html'&gt;eBay API documentation&lt;/a&gt;</summary>
    ...
    {
        /// <summary>The automatically spell-corrected keyword from the request.</summary>
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.15.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class AvailableCoupon 
    {
        ...
        /// <summary>The type of discount that the coupon applies. For implementation help, refer to &lt;a href='https://developer.ebay.com/devzone/rest/api-ref/browse/types/CouponDiscountType.html'&gt;eBay API documentation&lt;/a&gt;</summary>
        ...
        /// <summary>A description of the coupon. Note: The value returned in the termsWebUrl field should appear for all experiences when displaying coupons. The value in the availableCoupons.message field must also be included, if returned in the API response.</summary>
        ...
        /// <summary>The URL to the coupon terms of use. Note: The value returned in the termsWebUrl field should appear for all experiences when displaying coupons. The value in the availableCoupons.message field must also be included, if returned in the API response.</summary>
        [Newtonsoft.Json.JsonProperty("termsWebUrl", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    public partial class CartItem 
    {
        ...
        public Amount_0 CartItemSubtotal { get; set; }
    ...
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.15.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class CouponConstraint 
    {
        /// <summary>The expiration date of the coupon.</summary>
    ...
    public partial class Item 
    {
        ...
        /// <summary>A list of available coupons for the item.</summary>
        [Newtonsoft.Json.JsonProperty("availableCoupons", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<AvailableCoupon> AvailableCoupons { get; set; }
        ...
        /// <summary>The ID of the leaf category for this item. A leaf category is the lowest level in that category and has no children.</summary>
        [Newtonsoft.Json.JsonProperty("categoryId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string CategoryId { get; set; }
        ...
        /// <summary>The full description of the item that was created by the seller. This can be plain text or rich content and can be very large.</summary>
        [Newtonsoft.Json.JsonProperty("description", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string Description { get; set; }
    
        /// <summary>This field indicates if the item can be purchased using the Buy Order API. If the value of this field is true, this indicates that the item can be purchased using the Order API. If the value of this field is false, this indicates that the item cannot be purchased using the Order API and must be purchased on the eBay site.</summary>
        [Newtonsoft.Json.JsonProperty("eligibleForInlineCheckout", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public bool? EligibleForInlineCheckout { get; set; }
    
        /// <summary>This indicates if the item can be purchased using Guest Checkout in the Order API. You can use this flag to exclude items from your inventory that are not eligible for Guest Checkout, such as gift cards.</summary>
        ...
        /// <summary>This indicates the European energy efficiency rating (EEK) of the item. This field is returned only if the seller specified the energy efficiency rating. The rating is a set of energy efficiency classes from A to G, where 'A' is the most energy efficient and 'G' is the least efficient. This rating helps buyers choose between various models. When the manufacturer's specifications for this item are available, the link to this information is returned in the productFicheWebUrl field.</summary>
        ...
        /// <summary>The unique Global Trade Item number of the item as defined by https://www.gtin.info. This can be a UPC (Universal Product Code), EAN (European Article Number), or an ISBN (International Standard Book Number) value.</summary>
        ...
        /// <summary>The URL of the View Item page of the item, which includes the affiliate tracking ID. This field is only returned if the eBay partner enables affiliate tracking for the item by including the X-EBAY-C-ENDUSERCTX request header in the method. Note: eBay Partner Network, in order to be commissioned for your sales, you must use this URL to forward your buyer to the ebay.com site.</summary>
        ...
        /// <summary>The unique identifier of the eBay listing that contains the item. This is the traditional/legacy ID that is often seen in the URL of the listing View Item page.</summary>
        [Newtonsoft.Json.JsonProperty("legacyItemId", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string LegacyItemId { get; set; }
    
        /// <summary>An array of containers the complete list of the name/value pairs that describe the variation of the item.</summary>
        ...
        /// <summary>An array of the qualified programs available for the item, such as EBAY_PLUS. eBay Plus is a premium account option for buyers, which provides benefits such as fast free domestic shipping and free returns on selected items. Top-Rated eBay sellers must opt in to eBay Plus to be able to offer the program on qualifying listings. Sellers must commit to next-day delivery of those items. Note: eBay Plus is available only to buyers in Germany, Austria, and Australia marketplaces.</summary>
        ...
        public System.Collections.Generic.ICollection<string> QualifiedPrograms { get; set; }
        ...
        /// <summary>This indicates if the item a top-rated plus item. There are three benefits of a top-rated plus item; a minimum 30-day money-back return policy, shipping the items in 1 business day with tracking provided, and the added comfort of knowing this item is from experienced sellers with the highest buyer ratings. See the Top Rated Plus Items and Becoming a Top Rated Seller and qualifying for Top Rated Plus help topics for more information.</summary>
    ...
    public partial class ItemLocationImpl 
    {
        ...
        /// <summary>The postal code (or zip code in US) where the item is located. Sellers set a postal code (or zip code in US) for items when they are listed. The postal code is used for calculating proximity searches. It is anonymized when returned in itemLocation.postalCode via the API.</summary>
        [Newtonsoft.Json.JsonProperty("postalCode", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string PostalCode { get; set; }
    ...
    public partial class ItemSummary 
    {
        ...
        /// <summary>This boolean attribute indicates if coupons are available for the item.</summary>
        [Newtonsoft.Json.JsonProperty("availableCoupons", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <summary>The URL to the View Item page of the item, which includes the affiliate tracking ID. This field is only returned if the seller enables affiliate tracking for the item by including the X-EBAY-C-ENDUSERCTX request header in the method. Note: eBay Partner Network, in order to receive a commission for your sales, you must use this URL to forward your buyer to the ebay.com site.</summary>
        [Newtonsoft.Json.JsonProperty("itemAffiliateWebUrl", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string ItemAffiliateWebUrl { get; set; }
    ...
    public partial class Items 
    {
        ...
        /// <summary>A container with all of the warning messages for the response.</summary>
        [Newtonsoft.Json.JsonProperty("warnings", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public System.Collections.Generic.ICollection<Error> Warnings { get; set; }
    ...
    public partial class Product 
    {
        ...
        /// <summary>An array of all the possible GTINs values associated with the product. A GTIN is a unique Global Trade Item number of the item as defined by https://www.gtin.info. This can be a UPC (Universal Product Code), EAN (European Article Number), or an ISBN (International Standard Book Number) value.</summary>
    ...
    public partial class RemoteShopcartResponse 
    {
        ...
        public Amount_0 CartSubtotal { get; set; }
    ...
    /// <summary>The type that defines the fields for a paginated result set. The response consists of 0 or more sequenced &lt;em&gt; pages&lt;/em&gt; where each page has 0 or more items. </summary>
    [System.CodeDom.Compiler.GeneratedCode("NJsonSchema", "10.1.15.0 (Newtonsoft.Json v11.0.0.0)")]
    public partial class SearchPagedCollection 
    {
        [Newtonsoft.Json.JsonProperty("autoCorrections", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <summary>An array of the items on this page. The items are sorted according to the sorting method specified in the request.</summary>
    ...
    public partial class SellerDetail 
    {
        ...
        /// <summary>This indicates if the seller is a business or an individual. This is determined when the seller registers with eBay. If they register for a business account, this value will be BUSINESS. If they register for a private account, this value will be INDIVIDUAL. This designation is required by the tax laws in the following countries: This field is returned only on the following sites. EBAY_AT, EBAY_BE, EBAY_CH, EBAY_DE, EBAY_ES, EBAY_FR, EBAY_GB, EBAY_IE, EBAY_IT, EBAY_PL Valid Values: BUSINESS or INDIVIDUAL Code so that your app gracefully handles any future changes to this list.</summary>
        [Newtonsoft.Json.JsonProperty("sellerAccountType", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        public string SellerAccountType { get; set; }
    ...
    public partial class ShippingOption 
    {
        ...
        /// <summary>Indicates if the item qualifies for eBay's Global Shipping Program.</summary>
        [Newtonsoft.Json.JsonProperty("guaranteedDelivery", Required = Newtonsoft.Json.Required.Default, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
        ...
        /// <summary>The name of the shipping provider, such as FedEx, or USPS.</summary>
    ...
    public partial class Taxes 
    {
        ...
        /// <summary>This indicates if tax was applied for the cost of the item.</summary>
        ...
        /// <summary>This indicates if tax is applied for the shipping cost.</summary>
        ...
        /// <summary>This field indicates the type of tax that may be collected for the item. For implementation help, refer to &lt;a href='https://developer.ebay.com/devzone/rest/api-ref/browse/types/TaxType.html'&gt;eBay API documentation&lt;/a&gt;</summary>
